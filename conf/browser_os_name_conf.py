...
firefox_versions = ["82","83"]  #firefox versions for the tests to run against on Browserstack/Sauce Labs
...
default_config_list = [("firefox","83","windows","10")] #default configuration against which the test would run if no -B all option is used
